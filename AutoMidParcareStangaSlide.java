...
//@Config
//@Autonomous(name = "Autonom Mid Stanga Slide", group = "Pushbot")
public class AutoMidParcareStangaSlide extends LinearOpMode implements OpModeAddition {
    ...
    public static double slideTimeRight = 1.2;
    public static double slideTimePtJunction = 0.4;
...
//        robot.navigation.Turn(-unghiTurn1, turnSpeed);
        robot.navigation.SlideOnTime(slideTimePtJunction, speedSlide);
        robot.navigation.waitUntil(1);
...
//        robot.navigation.resetEncoders();
        ...
        if (tagOfInterest.id == LEFT) {
            ...
            robot.navigation.SlideOnTime(slideTimeLeft, -speedSlideParcare);
            ...
            robot.navigation.SlideOnTime(slideTimeRight, speedSlideParcare);
        }
