...
@Config
@Autonomous(name = "AutonomParcareCamera", group = "Pushbot")
public class AutonomParcareCamera extends LinearOpMode implements OpModeAddition {
    ...
    public static double slideTimeLeft = 1.45;
    public static double slideDeStart = 0.25;
    public static double slideTimeRight = 0.85;


    public static double timeFirstSlide = 0.3;
    public static double speedSlide = 0.4;
    public static double speedSlideParcare = 0.5;
    public static double speedFirstDrive = 0.3;

    public static int drive = 60;
    public static double turnSpeed = .3;
    public static double unghiTurn1 = 30;
    public static double unghiTurn2 = 30;
    public static double time = 1.4;
    public static double speedFataSpate = 0.3;
    public static double timeFataSpate = 0.8;
    public static int driveFataSpate = 15;
    public static int driveSpate = 10;
    public static double speedBack = 0.3;

    public static double slidePower2 = 0.5;
    public static double slideTimeLeft2 = 1.3;
    public static double slideDeStart2 = 0.2;
    public static double slideTimeRight2 = 1.2;
...
//        robot.navigation.DriveOnTime(timeFataSpate, speedFataSpate);
            ...
            robot.navigation.driveOnlyBack(-driveSpate, speedBack);
            robot.navigation.resetEncoders();
        }
        else {
            if (tagOfInterest.id == LEFT) {
                ...
                robot.navigation.waitUntil(0.5);
//            robot.navigation.SlideOnTime(2, -0.4);
//            robot.navigation.DriveOnTime(2.5, power);
                robot.navigation.driveOnlyBack(target, power);

            } else if (tagOfInterest.id == MIDDLE) {
                // caz 2
                robot.navigation.SlideOnTime(slideDeStart, -slidePower);
                robot.navigation.waitUntil(2);
//            robot.navigation.DriveOnTime(3, power);
                robot.navigation.driveOnlyBack(target, power);
